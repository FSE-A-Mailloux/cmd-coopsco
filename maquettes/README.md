...
- Le gestionnaire dispose d'un parcours d'**encaissement** dedie: recherche de commande puis saisie d'un ou plusieurs paiements cheque/espece.
- Pour un paiement par cheque, la saisie inclut **montant**, **banque** et **titulaire du compte** pour l'edition des bordereaux de fin de periode.
