...
Ces exigences decrivent des **regles fonctionnelles cibles** pour l'application a venir.  
Le dossier de maquettes reste un support de validation, mais n'est plus la source normative du comportement attendu.
